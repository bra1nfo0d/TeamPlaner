...
class AdditionalWindow(MainWindow):
	"""Secondary week view window synchronized with the main window."""
	
	def __init__(self, main_window, start_week: int):
		"""
		Args:
			main_window (MainWindow): The primary main window instance.
			start_week (int): Starting week index for this window.
		"""
